...
ROLL_OUTPUT_DIR="/net/projects2/ycleong/sg/strategy-rl/MARSHAL/results/kuhn_poker_selfplay/$(date +%Y%m%d-%H%M%S)"
...
python examples/start_agentic_pipeline.py \
  ...
  --config_name agentic_val_kuhn_poker_selfplay | tee $ROLL_LOG_DIR/custom_logs.log
